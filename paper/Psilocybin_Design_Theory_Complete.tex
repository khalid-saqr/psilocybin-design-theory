...
\section*{Operational CLI}
\href{../docs/cli.html}{Psilocybin Genesis CLI} operationalizes this theory-method into local design workspaces and agent-readable genesis repositories.
